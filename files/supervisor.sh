...
install() {
    ...
    cp -a /tmp/subscribed_file_ids.txt /opt/steam/insurgency/insurgency/
...
su steam -c "./srcds_linux -console +sv_lan 0 +servercfgfile server.cfg +map \"market hunt\" +maxplayers 48 -workshop" & wait ${!}
